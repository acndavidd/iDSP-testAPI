...
class RetailerController {
    ...
    getRetailerSummary(pRequest, pResponse) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                var vResult = JSON.parse(yield vOrmSvc.sp('get_retailer_summary', vParams));
    ...
    getSalesRoute(pRequest, pResponse) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                var vResult = yield vOrmSvc.sp('get_retailer_route', vParams);
                console.log("Query Done with result : " + JSON.stringify(vResult));
                pResponse.json(vResult);
            }
            catch (pErr) {
    ...
    // 		}
    // }
    retailerCallPreparation(pRequest, pResponse) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                var vResult = yield vOrmSvc.sp('get_retailer_call_prep', vParams);
    ...
    paymentHistory(pRequest, pResponse) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log("Start getting Physical Inventory");
                var vSelectedRetailId = pRequest.body.retailerId;
                ...
                var vResult = yield vOrmSvc.sp('get_payment_history', vParams);
                console.log("Query Done with result : " + JSON.stringify(vResponse));
                var vResponse = {
                    "status": "Success",
                    "errorMessage": "",
