...
@Component({
    // FOR HIT API
    templateUrl: './app/basic-call-procedure/components/hc-visited-retailer.component.html',
    // FOR HARDCODE UI
...
export class VisitedRetailerComponent {
    ...
    constructor (
        ...
        this._layoutService.setCurrentPage('VisitedRetailer');
        this._headerService.setTitle('Visited Retailer');
