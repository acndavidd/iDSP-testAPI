System.register(['angular2/core', 'angular2/router', '../../shared/services/match-media.service', '../../shared/services/layout.service', '../../shared/services/header.service', '../../shared/services/retailer.service', '../../shared/services/page-navigation.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            BCPCollectionComponent = (function () {
                function BCPCollectionComponent(_layoutService, _matchMediaService, _headerService, _retailerService, _pageNavigationService, _router) {
                    ...
                    this.vOutstandingShow = false;
                    this.vArrowMap = false;
                    this.vPaymentShow = false;
                ...
                BCPCollectionComponent.prototype.getResize = function () {
                    return this._matchMediaService.getMm();
                };
                BCPCollectionComponent.prototype.outstandingShow = function () {
                    this.vOutstandingShow = !this.vOutstandingShow;
                    this.vArrowMap = !this.vArrowMap;
                };
                BCPCollectionComponent.prototype.paymentShow = function () {
                    this.vPaymentShow = !this.vPaymentShow;
                    this.vArrowMap = !this.vArrowMap;
                };
                BCPCollectionComponent.prototype.gotoBCPActivityStep = function () {
                    this._pageNavigationService.navigate('BCPActivityStep', null, null);
                };
                BCPCollectionComponent = __decorate([
                    core_1.Component({
                ...
                ], BCPCollectionComponent);
                return BCPCollectionComponent;
            }());
            exports_1("BCPCollectionComponent", BCPCollectionComponent);
        }
    }
});
//# sourceMappingURL=bcp-collection.component.js.map