System.register(['angular2/core'], function(exports_1, context_1) {
    ...
    var core_1;
    var vDbSqlite, configChannel, vDbName, vDbLocation, SQLiteService;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            SQLiteService = (function () {
                ...
                SQLiteService.prototype.isApp = function () {
            ...
            exports_1("SQLiteService", SQLiteService);
        }
    }
});
